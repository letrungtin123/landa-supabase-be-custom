...
export const QUEUES = {
  ...
  USER_DELETE: process.env.USER_DELETE_QUEUE || 'LANDA_USER_DELETE',
  EMAIL_OUTBOX: process.env.EMAIL_OUTBOX_QUEUE || 'LANDA_EMAIL_OUTBOX',
  COURSE_PROGRESS_RECALC: process.env.COURSE_PROGRESS_RECALC_QUEUE || 'LANDA_COURSE_PROGRESS_RECALC',
} as const;
