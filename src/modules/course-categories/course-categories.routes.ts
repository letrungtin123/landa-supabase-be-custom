...
import {
  ...
  getCoursesController, addCoursesController, removeCourseController, publicImpactController,
...
router.get('/:id/public-impact', checkPermission('course_categories', 'can_view'), publicImpactController);
